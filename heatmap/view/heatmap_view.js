...
(function() {
  ...
  window.HeatmapView = (function(_super) {
    ...
    HeatmapView.prototype.addRows = function() {
      ...
      if (!this.model.get("hideGeneNames")) {
    ...
    HeatmapView.prototype.changeCurrentGeneName = function(e) {
      e.stopPropagation();
      return this.model.set({
        currentGeneName: e.type === "mouseover" ? d3.select(e.target.parentNode).attr("name") : null
      });
    };

    HeatmapView.prototype.changeClickedGeneName = function(e) {
      e.stopPropagation();
      return this.model.set({
        clickedGeneName: d3.select(e.target.parentNode).attr("name")
      });
    };
    ...
    HeatmapView.prototype.showCurrentGeneName = function() {
      ...
      if (currentGeneName != null) {
        currentGene = this.heatmap.select("[name=" + currentGeneName + "]");
        return currentGene.classed("current", 1);
      }
    };

    HeatmapView.prototype.showClickedGeneName = function() {
      var clickedGene, clickedGeneName;
      clickedGeneName = this.model.get("clickedGeneName");
      if (clickedGeneName != null) {
        clickedGene = this.heatmap.select("[name=" + clickedGeneName + "]");
    ...
    HeatmapView.prototype.removeClickedGeneName = function() {
